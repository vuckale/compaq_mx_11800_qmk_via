...
#define LAYOUT( \
    ...
    K50,    K6D, K60, K6E, K6F, K0F, K0C, K6C, K69, K6B, K6A, K0A, K1A, K18,                                   \
    K52, K00, K1D, K10, K1E, K1F, K7F, K7C, K1C, K19, K1B, K7A, K12,       K06,                          \
    K31,   K07,                  K78,                 K77,   K11,      K76, K75, K74                      \
) { \
    { K00,   KC_NO, KC_NO, K03,   K04,   KC_NO, K06,   K07,   K08,   K09,   K0A,   KC_NO, K0C,   K0D,   K0E,   K0F }, \
